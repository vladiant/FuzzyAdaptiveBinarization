...
small_image = 1.0 - import_img(image_path)
...
_, out_img_sugeno, c_m, s_m, T = adaptive_thresh2(
...
# cv2.imshow("integral image", int_img.astype(np)) # uint32

cv2.imshow("sugeno", out_img_sugeno)
